...
const Homepage = (props) => {
    return (
        <div className="homepage-container1">
            <Helmet>
                <title>VoltGrid | Formula 1 Inspired Game UI Components</title>
                <meta
                    name="description"
                    content="Explore React components for betting forms, trade dashboards, and fantasy game profiles. Formula 1 TV-inspired design with yellow, grey, and black."
                />
                <meta
                    property="og:title"
                    content="VoltGrid | Formula 1 Inspired Game UI Components"
                />
                <meta
                ...
                <link
                    rel="canonical"
                    href="https://ripe-sympathetic-cormorant-9ilgxh.teleporthq.site/homepage"
                />
                <meta
                    property="og:url"
                    content="https://ripe-sympathetic-cormorant-9ilgxh.teleporthq.site/homepage"
                />
                <script
                    type="application/ld+json"
                    dangerouslySetInnerHTML={{
                        __html:
                            '{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://ripe-sympathetic-cormorant-9ilgxh.teleporthq.site"},{"@type":"ListItem","position":2,"name":"Homepage","item":"https://ripe-sympathetic-cormorant-9ilgxh.teleporthq.site/homepage"}]}',
                    }}
                />
            </Helmet>
                ...
                <div className="volt-hero-container">
                    <div className="volt-hero-content">
                        ...
                        <div className="volt-hero-actions">
                            <Link to="/homepage" className="homepage-navlink1">
            ...
            >
                ...
                <div className="volt-cta-container">
                    ...
                    <div className="volt-cta-actions">
                        <Link to="/homepage" className="homepage-navlink3">
            ...
            <div className="homepage-container2">
                <div className="homepage-container3">
                    <Script
                        html={`<script defer data-name="voltgrid-ui">
(function(){
