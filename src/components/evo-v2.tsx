...
const EvoV2 = ({ hideSubmit }: { hideSubmit?: boolean }) => {
    const picks = usePredictionStore(state => state.evoV2);
    const setPicks = usePredictionStore(state => state.setEvoV2);
    ...
    return (
        <div className="w-full flex flex-col gap-4 mt-8">
            <header className="f1-predictions-header border border-[#ffffff3d] p-6 bg-[#1a1a1a] border-b-2 border-b-[#fbaa19] shadow-md mb-2">
                ...
                <h2 className="text-white text-2xl md:text-3xl font-['Saira'] font-bold uppercase tracking-wider mb-2">EVO V2 (BIGGEST MOVERS)</h2>
                <p className="text-gray-400 text-sm md:text-base">
                    Alternative UI: Select the 5 drivers you predict will gain the most positions.
                </p>
            </header>
